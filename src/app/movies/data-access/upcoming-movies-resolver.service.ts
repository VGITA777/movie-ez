...
export class UpcomingMoviesResolverService extends CachedResolve<UpcomingMovies, ExpirableSimpleCache> {
  ...
  constructor() {
    const localStorage = new LocalStorageCacheManager(UPCOMING_MOVIES_NAMESPACE);
